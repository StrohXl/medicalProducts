...
const CreateSubCategorie = () => {
  ...
  const Guardar = async () => {
    ...
    try {
        await axios.post(`${url}/sub_categories/`, dataJson )
      ...
      content: (
        <>
          <Form
            ...
            onValuesChange={(i)=>{setDataForm(i), console.log(i)}}
          >
            <FormItem
              name="name"
  ...
  return (
    <>
      <Steps steps={datos} Guardar={Guardar} paso1={dataForm} paso2={selectRows} />
    </>
  );
};
